...
exports.planners = exports.stories = exports.festivals = exports.experiences = exports.itineraries = exports.destinations = exports.hero = void 0;
exports.hero = {
    title: 'Armenia, crafted for the soulful traveler',
    subtitle: 'Caucasus journeys reimagined',
    description: 'Traverse monasteries carved into cliffs, taste ancient vintages and modern cuisine, meet artisans shaping the nation’s new chapter, and rest in design-led boutique stays.',
...
exports.itineraries = [
    {
        ...
        audience: 'Couples',
        pace: 'Balanced',
        summary: 'From the ochre vineyards of Areni to candlelit vespers in rock-hewn chapels, this itinerary balances culinary artistry with meditative heritage.',
...
exports.planners = {
    generateRecommendation: (request) => {
        const highlightMatches = exports.itineraries
        ...
        return {
            ...
            summary: 'We will layer heritage encounters, culinary artisans, and design-led stays to mirror your travel energy. Expect daily moments of spontaneity guided by our expert hosts.',
